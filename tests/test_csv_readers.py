...
class TestCsvReaders(TestCase):
    ...
    def test_get_diagnoses(self):
        ...
        diagnoses_p5 = [Diagnosis(disease_TE1_000, d(2010, 1, 1), d(2010, 10, 31), "John Deer"),
        ...
        diagnoses_p123 = [Diagnosis(disease_TE1_000, d(2010, 1, 1), d(2010, 1, 31), "John Deer"),
        ...
        self.assertEqual(self.diagnoses,
                         {5: diagnoses_p5, 123: diagnoses_p123})
